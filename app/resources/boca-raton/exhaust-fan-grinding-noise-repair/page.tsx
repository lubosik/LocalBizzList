...
export const metadata: Metadata = {
  title: 'Exhaust Fan Making Loud Grinding Noise Boca Raton | Emergency Fan Repair',
  description: 'Emergency exhaust fan repair for Boca Raton restaurants experiencing loud grinding noise. Same-day fan motor replacement with NFPA 96 certified technicians.',
  keywords: [
    'exhaust fan grinding noise Boca Raton',
    'kitchen exhaust fan repair Boca Raton',
    'restaurant exhaust fan loud noise Boca Raton',
    'commercial exhaust fan grinding Boca Raton',
    'hood fan motor replacement Boca Raton',
    'emergency fan repair Boca Raton',
    'kitchen hood fan repair Boca Raton',
    'restaurant exhaust fan repair Boca Raton'
  ],
  openGraph: {
    title: 'Exhaust Fan Making Loud Grinding Noise Boca Raton | Emergency Fan Repair',
    description: 'Emergency exhaust fan repair for Boca Raton restaurants experiencing loud grinding noise. Same-day fan motor replacement available.',
    type: 'article',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Commercial kitchen exhaust fan repair Boca Raton'
      }
    ]
  }
}

export default function ExhaustFanGrindingNoiseBocaRatonPage() {
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Exhaust Fan Making Loud Grinding Noise Boca Raton | Emergency Fan Repair",
    "description": "Emergency exhaust fan repair for Boca Raton restaurants experiencing loud grinding noise. Same-day fan motor replacement with NFPA 96 certified technicians.",
    "author": {
      "@type": "Organization",
      "name": "LocalBizzList"
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://localbizzlist.com/resources/boca-raton/exhaust-fan-grinding-noise-repair"
    }
  }
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What causes exhaust fan grinding noise in Boca Raton restaurants?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Grinding noise typically indicates worn bearings, misaligned fan blades, or motor issues. Boca Raton's coastal climate with high humidity and salt air accelerates bearing wear and can cause corrosion that leads to grinding sounds."
        }
      },
      {
        "@type": "Question",
        "name": "How quickly can you repair a grinding exhaust fan in Boca Raton?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We provide same-day emergency fan repair service throughout Boca Raton and Palm Beach County. Most grinding noise issues can be diagnosed and repaired within 2-4 hours of service call."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "What does exhaust fan motor replacement cost in Boca Raton?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Do you repair all types of commercial exhaust fans in Boca Raton?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "What areas of Boca Raton do you serve for emergency fan repair?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We provide emergency exhaust fan repair throughout Boca Raton and surrounding Palm Beach County areas, including Downtown Boca, Mizner Park, and surrounding communities."
        }
      }
    ]
  }
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Exhaust Fan Making Loud Grinding Noise in Boca Raton
            </h1>
            <p className="text-xl mb-8 leading-relaxed">
              Emergency exhaust fan repair for Boca Raton restaurants experiencing loud grinding noise. 
              Same-day fan motor replacement with NFPA 96 certified technicians throughout Palm Beach County.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                href="/pricing/instant-quote?src=resource_boca-raton_exhaust-fan-grinding-noise-repair_mid"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a href="#boca-raton-context" className="text-blue-600 hover:text-blue-800 font-medium">Boca Raton Exhaust Fan Issues</a>
              ...
              <a href="#local-realities" className="text-blue-600 hover:text-blue-800 font-medium">Boca Raton Service Considerations</a>
      ...
      <article className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section id="boca-raton-context" className="mb-16">
            <h2 className="text-3xl font-bold mb-6">Boca Raton Exhaust Fan Issues</h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 mb-6">
                Boca Raton's coastal climate creates unique challenges for commercial exhaust fans, with high humidity and salt air 
              ...
              <div className="bg-orange-50 border-l-4 border-orange-500 p-6 mb-8">
                <h3 className="text-xl font-bold text-orange-800 mb-3">Why Boca Raton Exhaust Fans Develop Grinding Noise</h3>
                <ul className="space-y-2 text-orange-700">
                  ...
                  <li className="flex items-start">
                    <Wrench className="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Seasonal tourist demand affects maintenance schedules</span>
                  </li>
                  <li className="flex items-start">
                    <Wrench className="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" />
              ...
              <p className="text-lg text-gray-700">
                ...
                issues within hours, minimizing downtime for your Boca Raton restaurant.
              </p>
            </div>
          </section>
          ...
          <section id="cost-frequency" className="mb-16">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 mb-6">
                ...
                Most grinding noise problems can be resolved within hours, minimizing downtime for your Boca Raton restaurant.
              </p>
              ...
              <div className="bg-orange-600 text-white p-8 rounded-lg text-center mb-8">
                ...
                <p className="text-lg mb-6">Don't let grinding noise shut down your Boca Raton restaurant kitchen</p>
                <Link 
                  href="/pricing/instant-quote?src=resource_boca-raton_exhaust-fan-grinding-noise-repair_mid"
          ...
          <section id="process-checklist" className="mb-16">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 mb-6">
                ...
                proper diagnosis and long-term reliability for your Boca Raton restaurant.
              </p>
          ...
          <section id="local-realities" className="mb-16">
            <h2 className="text-3xl font-bold mb-6">Boca Raton Service Considerations</h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 mb-6">
                Boca Raton's unique coastal environment and upscale restaurant landscape present specific considerations for emergency exhaust fan repair. 
                Understanding these local factors ensures efficient service and prevents future grinding noise issues.
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  <h3 className="text-xl font-bold mb-4 text-orange-600">Boca Raton Climate Factors</h3>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span><strong>Traffic considerations:</strong> Mizner Park vs. downtown access times</span>
                    </li>
                    <li className="flex items-start">
                      <Clock className="w-5 h-5 mr-2 mt-0.5 text-orange-500 flex-shrink-0" />
              ...
              <div className="bg-green-50 border-l-4 border-green-500 p-6 mb-8">
                <h3 className="text-xl font-bold text-green-800 mb-3">Boca Raton Restaurant Operations</h3>
                <p className="text-green-700 mb-4">
                  Boca Raton's upscale dining establishments and seasonal tourism create unique demands on exhaust systems. 
                ...
                <ul className="space-y-2 text-green-700">
                  ...
                  <li>• Experience with high-end establishments and their requirements</li>
                  <li>• Understanding of Palm Beach County health department standards</li>
                  <li>• Discreet service to maintain restaurant reputation</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section id="common-problems" className="mb-16">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-700 mb-6">
                ...
                proper maintenance for ongoing reliability in Boca Raton's challenging coastal environment.
              </p>
              ...
              <div className="space-y-8">
                <div className="bg-red-50 p-6 rounded-lg">
                  ...
                  <p className="text-red-700 mb-4">
                    Boca Raton's proximity to the ocean causes salt air to accelerate corrosion in exhaust fan components, 
                ...
                <div className="bg-yellow-50 p-6 rounded-lg">
                  <h3 className="text-xl font-bold text-yellow-800 mb-4">Problem: Seasonal Maintenance Gaps</h3>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <p className="text-blue-700 mb-4">
                    Upscale Boca Raton restaurants require discreet service and minimal disruption to maintain 
                    their premium reputation and customer experience during repairs.
                  </p>
                  <div className="bg-white p-4 rounded-lg">
                    <h4 className="font-bold text-gray-800 mb-2">Solution:</h4>
                    <ul className="space-y-1 text-gray-700">
                      <li>• Schedule repairs during off-peak hours</li>
          ...
          <section id="faqs" className="mb-16">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-3">What causes exhaust fan grinding noise in Boca Raton restaurants?</h3>
                <p className="text-gray-700">
                  Grinding noise typically indicates worn bearings, misaligned fan blades, or motor issues. Boca Raton's coastal climate with high humidity and salt air accelerates bearing wear and can cause corrosion that leads to grinding sounds.
                </p>
              </div>

              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-3">How quickly can you repair a grinding exhaust fan in Boca Raton?</h3>
                <p className="text-gray-700">
                  We provide same-day emergency fan repair service throughout Boca Raton and Palm Beach County. Most grinding noise issues can be diagnosed and repaired within 2-4 hours of service call.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-3">What does exhaust fan motor replacement cost in Boca Raton?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-3">Do you repair all types of commercial exhaust fans in Boca Raton?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-3">What areas of Boca Raton do you serve for emergency fan repair?</h3>
                <p className="text-gray-700">
                  We provide emergency exhaust fan repair throughout Boca Raton and surrounding Palm Beach County areas, including Downtown Boca, Mizner Park, and surrounding communities.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-orange-600 text-white p-8 rounded-lg text-center">
            ...
            <p className="text-xl mb-6">
              Don't let grinding noise shut down your Boca Raton restaurant kitchen. Get emergency exhaust fan repair 
              with same-day service available throughout Palm Beach County.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/pricing/instant-quote?src=resource_boca-raton_exhaust-fan-grinding-noise-repair_end"
          ...
          <section className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link href="/resources/boca-raton/exhaust-fan-problems-and-fixes" className="bg-gray-50 p-6 rounded-lg hover:bg-gray-100 transition-colors">
                <h3 className="text-xl font-bold text-blue-600 mb-2">Kitchen Exhaust Fan Problems & Quick Fixes</h3>
                <p className="text-gray-700">Comprehensive guide to common exhaust fan issues and troubleshooting steps for Boca Raton restaurants.</p>
              </Link>
