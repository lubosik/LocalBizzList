...
const articleMeta = {
  ...
  cta_targets: {
    primary: '/pricing/instant-quote?src=resource_miami_frequency_mid',
            ...
            <article className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <div className="my-12 bg-gradient-to-r from-green-600 to-green-700 rounded-lg p-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link 
                    href="/pricing/instant-quote?src=resource_miami_frequency_end"
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://localbizzlist.com/resources/miami/hood-cleaning-frequency-by-restaurant-type"
              }
            ]
          })
        }}
