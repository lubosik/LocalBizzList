...
import { XCircle, AlertTriangle, Droplets, Shield, CheckCircle, Clock, Zap, MapPin } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <Image
                ...
                alt="What not to flush in Fort Lauderdale septic systems"
                width={1200}
                height={400}
            ...
            <section className="mb-12 bg-gray-50 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">Maintenance tips and timing guide</p>
                </a>
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">Problem prevention and early detection</p>
                </a>
              </div>
            </section>
            ...
            <div className="bg-green-600 text-white p-8 rounded-lg text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/pricing/instant-quote/septic-tank-services?src=septic_fort-lauderdale_what-not-to-flush_mid"
