...
import { Utensils, AlertTriangle, Droplets, Clock, CheckCircle, Shield } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-orange-600 text-white p-8 rounded-lg text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/pricing/instant-quote/septic-tank-services?src=ftl-restaurants-septic-mid"
