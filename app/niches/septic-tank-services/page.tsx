    ...
    <>
      ...
      <section className="bg-gradient-to-b from-primary to-primary-int py-20">
        <div className="container text-center text-white">
          ...
          <Link
            href="/pricing/instant-quote/septic-tank-services?src=niche_septic-tank-services"
      ...
      <section className="bg-primary py-12">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link
            href="/pricing/instant-quote/septic-tank-services?src=niche_septic-tank-services_footer"
